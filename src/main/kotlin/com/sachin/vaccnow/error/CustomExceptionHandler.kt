...
class CustomExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    fun duplicateRecordFound(ex: RecordNotFoundException, request: WebRequest?): ResponseEntity<ErrorResponse?>? {
    ...
    fun duplicateRecordFound(ex: DuplicateRecordFoundException, request: WebRequest?): ResponseEntity<ErrorResponse?>? {
        var errorResponse = ErrorResponse(
